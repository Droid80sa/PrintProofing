...
def _send_via_custom_smtp(subject: str, body: str, to_address: str, smtp_config: dict) -> None:
    ...
    if use_ssl:
        with smtplib.SMTP_SSL(host, port, context=context) as server:
            ...
            server.sendmail(sender, [to_address], message.encode("utf-8"))
    else:
...
def _send_email_sync(
    ...
    *,
    ...
    if smtp_config:
        ...
        try:
            _send_via_custom_smtp(subject, body, to_address, smtp_config)
            return
